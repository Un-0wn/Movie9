...
class LatestPagingAdapter (private val latestAdapterListener: LatestAdapterListener) :
    PagingDataAdapter<Movie, LatestPagingAdapter.LatestViewHolder>(COMPARATOR) {
